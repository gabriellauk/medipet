...
def test_get_weights_for_animal(logged_in_client: FlaskClient) -> None:
    ...
    animal = models.Animal(name="Fluffy", animal_type=animal_type, user=user)
    weights = [
        models.Weight(weight=412, date=date(2024, 12, 10), animal=animal),
        models.Weight(weight=410, date=date(2024, 12, 15), animal=animal),
        models.Weight(weight=408, date=date(2024, 12, 12), animal=animal),
    ]
    ...
    assert response.json == {
        "data": [
            {"weight": 410, "date": "2024-12-15", "id": 2},
            {"weight": 408, "date": "2024-12-12", "id": 3},
            {"weight": 412, "date": "2024-12-10", "id": 1},
        ]
    }
...
def test_update_weight(logged_in_client: FlaskClient) -> None:
    ...
    request_data = {"weight": 412, "date": "2025-01-06"}
